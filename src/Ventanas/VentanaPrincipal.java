   ...
   Calendar calendario;
    ...
    public VentanaPrincipal() {
        initComponents();
         h1 = new Thread(this);
        h1.start();
        log.debug("Iniciando Ventana principal");
...
public void mostrarfecha() {
   ...
   public void calcula() {
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addComponent(jLabelFecha, javax.swing.GroupLayout.PREFERRED_SIZE, 131, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(56, 56, 56)
                .addComponent(jLabel2)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jLabelhora, javax.swing.GroupLayout.PREFERRED_SIZE, 131, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(85, 85, 85))
        );
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                ...
                                .addComponent(jLabel2))
                            .addComponent(jLabelFecha, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 14, javax.swing.GroupLayout.PREFERRED_SIZE))))
                .addContainerGap())
        );
    ...
    private void jMenuItem2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem2ActionPerformed
            InterfalFrameCategorias categoriaFrame= new InterfalFrameCategorias();
        if (categoriaFrame.isShowing()) {
            JOptionPane.showMessageDialog(null, "Ya Esta abierto!", "Advertencia", JOptionPane.ERROR_MESSAGE);
        } else {
            int x = (jDesktopPane1.getWidth() / 2) - categoriaFrame.getWidth() / 2;
            int y = (jDesktopPane1.getHeight() / 2) - categoriaFrame.getHeight() / 2;
            jDesktopPane1.add(categoriaFrame);
            categoriaFrame.setSize(708, 520);
            categoriaFrame.setLocation(x, y);
            categoriaFrame.show();
        }
    }//GEN-LAST:event_jMenuItem2ActionPerformed

    private void jMenuItem3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem3ActionPerformed
        InterfalFrameCuentas cuantasFrame= new InterfalFrameCuentas();
        if (cuantasFrame.isShowing()) {
            JOptionPane.showMessageDialog(null, "Ya Esta abierto!", "Advertencia", JOptionPane.ERROR_MESSAGE);
        } else {
            int x = (jDesktopPane1.getWidth() / 2) - cuantasFrame.getWidth() / 2;
            int y = (jDesktopPane1.getHeight() / 2) - cuantasFrame.getHeight() / 2;
            jDesktopPane1.add(cuantasFrame);
            cuantasFrame.setSize(708, 520);
            cuantasFrame.setLocation(x, y);
            cuantasFrame.show();
        }
...
@Override
    public void run() {
        ...
        while (ct == h1) {
            ...
            calcula();
            jLabelhora.setText(hora + ":" + minutos + ":" + segundos + " " + ampm);
            try {
                Thread.sleep(1000);
