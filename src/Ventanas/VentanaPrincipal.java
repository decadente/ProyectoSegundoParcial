...
public class VentanaPrincipal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jMcuenta = new javax.swing.JMenuItem();
        ...
        jMcuenta.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jMcuentaActionPerformed(evt);
            }
        });
        jMenu5.add(jMcuenta);
    ...
    private void jMcuentaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMcuentaActionPerformed
            InterfalFrameCategorias Cuantaframe=new InterfalFrameCategorias();
        if (Cuantaframe.isShowing()) {
            int x = (jDesktopPane1.getWidth() / 2) - Cuantaframe.getWidth() / 2;
            int y = (jDesktopPane1.getHeight() / 2) - Cuantaframe.getHeight() / 2;
            jDesktopPane1.add(Cuantaframe);
            Cuantaframe.setLocation(x, y);
            Cuantaframe.show();
        } else {
            JOptionPane.showMessageDialog(null, "Ya Esta abierto!", "Advertencia", JOptionPane.ERROR_MESSAGE);
        }
    }//GEN-LAST:event_jMcuentaActionPerformed

    private void jMcategoriasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMcategoriasActionPerformed
            InterfalFrameCategorias internal= new InterfalFrameCategorias();
        if (internal.isShowing()) {
            int x = (jDesktopPane1.getWidth() / 2) - internal.getWidth() / 2;
            int y = (jDesktopPane1.getHeight() / 2) - internal.getHeight() / 2;
    ...
    private javax.swing.JMenuItem jMcuenta;
